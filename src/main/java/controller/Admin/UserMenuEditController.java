...
public class UserMenuEditController {
    ...
    private void initialize(){
        ...
        this.supervisorList = UserService.searchMbikqyresi(this.txtSearch.getText());
    ...
    private void handleEdit(ActionEvent ae){
        if(edit){
            ...
            if(UserRepository.editMbikqyresi(
                    new UserEditDto(
                ...
                System.out.println("PopUp Ticks");
//                PopUp.tick(150);
            }else{
                System.out.println("Edit not succesful");
            }
            this.supervisorList = UserService.searchMbikqyresi(SESSION.getAdmin_supervisor_lastSearch());
            this.setColumns();
            this.disableForms();
    ...
    private void handleDelete(ActionEvent ae){
        if(UserRepository.deleteSupervisor(Integer.parseInt(this.txtId.getText()))){
//            PopUp.tick(150);
            System.out.println("PopUp tick");
            this.supervisorList = UserService.searchMbikqyresi(SESSION.getAdmin_supervisor_lastSearch());
            this.setColumns();
        }else{
