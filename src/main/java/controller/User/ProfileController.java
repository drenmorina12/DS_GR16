...
import model.dto.User.SupervisorProfileToControllerDto;
...
public class ProfileController {
    ...
    private void initialize(){
        ...
        this.disable();
        SupervisorProfileToControllerDto supervisor = UserService.getProfileInfo(SESSION.getLoggedUserEmail());
